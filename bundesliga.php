...
<ul class="dropdown-menu dropdown-menu-right">
	...
	<li class="hq">HD 720p</li>
			...
			<div class="text-center">
						<p class="lead" itemprop="description">Watch Online <?php echo '' . htmlspecialchars($_GET["match"]) . ''; ?> Live Streaming HD Quality Fast Without Buffering Support Mobile Android, iPhone, iPad, Tablet.</p>
					</div>
			</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="modal-footer">
					<div class="text-center">
						<button class="btn btn-warning btn-lg btn-responsive" onclick="window.location.href='/sign-in.php?match=<?php echo '' . htmlspecialchars($_GET["match"]) . ''; ?>'">
							
								<span class="icon icon-arrow-right-circle"></span>
							</span> Sign In
						</button>
						<button class="btn btn-success btn-lg btn-responsive" onclick="window.location.href='<?php echo $offer_international;?>'">
